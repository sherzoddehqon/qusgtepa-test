...
var format_Qushtepapilot4ekinline_2 = new ol.format.GeoJSON();
var features_Qushtepapilot4ekinline_2 = format_Qushtepapilot4ekinline_2.readFeatures(json_Qushtepapilot4ekinline_2, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_Qushtepapilot4ekinline_2 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_Qushtepapilot4ekinline_2.addFeatures(features_Qushtepapilot4ekinline_2);
var lyr_Qushtepapilot4ekinline_2 = new ol.layer.Vector({
                declutter: true,
                source:jsonSource_Qushtepapilot4ekinline_2, 
                style: style_Qushtepapilot4ekinline_2,
                interactive: true,
                title: '<img src="styles/legend/Qushtepapilot4ekinline_2.png" /> Qushtepa pilot4 — ekin line'
            });
...
lyr_OSMStandard_0.setVisible(true);lyr_GoogleSatelliteHybrid_1.setVisible(true);lyr_Qushtepapilot4ekinline_2.setVisible(true);lyr_Qushtepapilot4kanal_3.setVisible(true);lyr_Qushtepapilot4blokgaulash_4.setVisible(true);lyr_Qushtepapilot4zatvor_5.setVisible(true);lyr_Qushtepapilot4gidropost_6.setVisible(true);
var layersList = [lyr_OSMStandard_0,lyr_GoogleSatelliteHybrid_1,lyr_Qushtepapilot4ekinline_2,lyr_Qushtepapilot4kanal_3,lyr_Qushtepapilot4blokgaulash_4,lyr_Qushtepapilot4zatvor_5,lyr_Qushtepapilot4gidropost_6];
lyr_Qushtepapilot4ekinline_2.set('fieldAliases', {'fid': 'fid', 'yer_turi_ref': 'Yer turi', 'massiv_ref': 'Massiv', 'tuman_ref': 'Tuman', 'viloyat_ref': 'Viloyat', 'kontur_raqami': 'Kontur', 'id': 'id', 'kim_yaratgan': 'kim_yaratgan', 'yaratilis_sanasi': 'yaratilis_sanasi', 'kim_yangilangan': 'kim_yangilangan', 'yangilanish_sanasi': 'yangilanish_sanasi', 'bog_turi_ref': 'Bog\' turi', 'irrigatsiya_statusi_ref': 'Irrigatsiya', 'maydoni': 'maydoni, gektar', 'izoh': 'izoh', 'tasdiqlangan': 'tasdiqlangan', 'INDEX': 'Index', 'ekin': 'Ekin', });
...
lyr_Qushtepapilot4ekinline_2.set('fieldImages', {'fid': 'Hidden', 'yer_turi_ref': 'TextEdit', 'massiv_ref': 'TextEdit', 'tuman_ref': 'TextEdit', 'viloyat_ref': 'TextEdit', 'kontur_raqami': 'TextEdit', 'id': 'Hidden', 'kim_yaratgan': 'Hidden', 'yaratilis_sanasi': 'Hidden', 'kim_yangilangan': 'Hidden', 'yangilanish_sanasi': 'Hidden', 'bog_turi_ref': 'TextEdit', 'irrigatsiya_statusi_ref': 'TextEdit', 'maydoni': 'TextEdit', 'izoh': 'Hidden', 'tasdiqlangan': 'Hidden', 'INDEX': 'ExternalResource', 'ekin': 'TextEdit', });
...
lyr_Qushtepapilot4ekinline_2.set('fieldLabels', {'yer_turi_ref': 'inline label', 'massiv_ref': 'inline label', 'tuman_ref': 'inline label', 'viloyat_ref': 'inline label', 'kontur_raqami': 'inline label', 'bog_turi_ref': 'inline label', 'irrigatsiya_statusi_ref': 'inline label', 'maydoni': 'inline label', 'INDEX': 'inline label', 'ekin': 'inline label', });
